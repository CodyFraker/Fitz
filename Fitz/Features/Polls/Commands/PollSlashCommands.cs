            ...
            switch (pollType)
            {
                case PollType.Number:
                    var numberModal = ModalBuilder.Create("gen_number")
                        ...
                        .AddComponents(new DiscordTextInputComponent($"{DiscordEmoji.FromName(ctx.Client, ":bar_chart:")}Poll Title", "genNumberPollTitle", "Number Poll Title", required: true, max_length: 256))
                ...
                case PollType.YesOrNo:
                    var yesOrNoModal = ModalBuilder.Create("gen_yesno")
                        ...
                        .AddComponents(new DiscordTextInputComponent($"{DiscordEmoji.FromName(ctx.Client, ":bar_chart:")}Poll Title", "yesnoPollTitle", "Yes or No Poll Title", required: true, max_length: 256));
                ...
                case PollType.Color:
                    var colorModal = ModalBuilder.Create("generate_color_poll")
                        ...
                        .AddComponents(new DiscordTextInputComponent($"{DiscordEmoji.FromName(ctx.Client, ":bar_chart:")}Poll Title", "colorPollTitle", "Color Poll Title", required: true, max_length: 256))
                        .AddComponents(new DiscordTextInputComponent(
                ...
                case PollType.ThisOrThat:
                    var thisOrThatModal = ModalBuilder.Create("gen_thisorthat")
                        ...
                        .AddComponents(new DiscordTextInputComponent($"{DiscordEmoji.FromName(ctx.Client, ":bar_chart:")}Poll Title", "thisOrThatPollTitle", "", required: true, max_length: 256))
                        .AddComponents(new DiscordTextInputComponent($"This{DiscordEmoji.FromName(ctx.Client, ":point_left:")}", "This", "This", required: true, style: DiscordTextInputStyle.Short, max_length: 64))
                        .AddComponents(new DiscordTextInputComponent($"{DiscordEmoji.FromName(ctx.Client, ":point_right:")}That", "That", "That", required: true, style: DiscordTextInputStyle.Short, max_length: 64));
                ...
                case PollType.HotTake:
                    var hotTakeModal = ModalBuilder.Create("gen_hottake")
                        ...
                        .AddComponents(new DiscordTextInputComponent($"{DiscordEmoji.FromName(ctx.Client, ":bar_chart:")}Poll Title", "Poll Title", "Poll Title", required: true, max_length: 256));
