...
namespace Fitz.Api.Controllers.Bank.AwardBonus.Persistence;

public class AwardBonus(IDbContextFactory<BotContext> contextFactory, ILogger<AwardBonus> logger) : IAwardBonus
{
    private readonly IDbContextFactory<BotContext> _contextFactory = contextFactory;
    private readonly ILogger<AwardBonus> _logger = logger;
