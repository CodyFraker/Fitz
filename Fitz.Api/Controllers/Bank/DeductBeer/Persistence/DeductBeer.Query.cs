...
namespace Fitz.Api.Controllers.Bank.DeductBeer.Persistence;

public class DeductBeer(IDbContextFactory<BotContext> contextFactory, ILogger<DeductBeer> logger) : IDeductBeer
{
    private readonly IDbContextFactory<BotContext> _contextFactory = contextFactory;
    private readonly ILogger<DeductBeer> _logger = logger;
