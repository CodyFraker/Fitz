...
[DisplayName("PostPollToPendingResponse")]
public record PostPollToPendingResponseDto
{
    [Required]
    ...
    public static PostPollToPendingResponseDto From(PostPollToPendingResponse response)
    {
        return new PostPollToPendingResponseDto
        {
            Id = response.Id,
