...
[DisplayName("GetPollResponse")]
public record GetPollResponseDto
{
    [Required]
    ...
    public static GetPollResponseDto From(GetPollResponse response)
    {
        return new GetPollResponseDto
        {
            Id = response.Id,
