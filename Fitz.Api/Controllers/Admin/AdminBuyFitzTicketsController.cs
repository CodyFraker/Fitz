...
namespace Fitz.Api.Controllers.Admin
{
    ...
    public class AdminBuyFitzTicketsController : ControllerBase
    {
        private readonly LotteryService _lotteryService;
        private readonly FitzMetrics? _fitzMetrics;

        public AdminBuyFitzTicketsController(LotteryService lotteryService, FitzMetrics? fitzMetrics = null)
        {
        ...
        [RequireDiscordAuth]
        [RequireAdmin]
        public async Task<IActionResult> BuyFitzTickets([FromBody] AdminBuyFitzTicketsRequest request)
        {
            ...
            try
            {
                ...
                var result = await _lotteryService.BuyTicketsForFitz(request.Tickets);
                if (!result.Success)
                {
