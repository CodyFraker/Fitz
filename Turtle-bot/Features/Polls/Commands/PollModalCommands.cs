...
namespace Fitz.Features.Polls.Polls
{
    public class PollModalCommands : ModalCommandModule
    {
        ...
        public async Task GenerateNumberPoll(ModalContext ctx, string question, string choices)
        {
            ...
            DiscordButtonComponent accpetBtn = new DiscordButtonComponent(DiscordButtonStyle.Success, "poll_confirm", "Confirm", false);
            DiscordButtonComponent cancelBtn = new DiscordButtonComponent(DiscordButtonStyle.Danger, "poll_cancel", "Cancel", false);
